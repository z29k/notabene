...
- `npm i -D pagefind` dans votre repo et ce même workflow embarque aussi la
  [recherche plein texte](./index.md#recherche-plein-texte-optionnelle) — `npm ci`
  l'installe, le build la détecte. Rien à changer ici.
