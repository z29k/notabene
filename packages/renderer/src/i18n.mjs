...
const MESSAGES = {
  ...
  fr: {
    ...
    identityTitle: "Ton identité",
    identityLede: "Affichée sur les commentaires que tu laisses — enregistrée sur cet appareil uniquement.",
    identityNudge: "Présente-toi avant de continuer — tes commentaires te seront attribués.",
    identityName: "Nom",
    identityEmail: "Email",
    identityEmailOptional: "(optionnel)",
    identityEmailHint: "Recommandé — rend ton identité unique (ex. deux personnes nommées Alex).",
    identityHint: "Ton identité (nom + email) — clique pour modifier",
