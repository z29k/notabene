...
build, `notabene lint`, `notabene comments verify` (store ↔ journal coherence), and the
project's `verify[]` checks. Ignore comments on hold. Report as a table and **never commit
